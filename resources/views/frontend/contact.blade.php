                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <form method="post" class="form-customer form-login">
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="flexRadioDefault2">
                                {{ trans('lang.Complaint') }}
                            </label>
                        </div>

                        <div class="form-group">
                            <input type="email" class="form-control form-account" placeholder="{{ trans('lang.Full Name') }}">
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control form-account" placeholder="{{ trans('lang.Email') }}">
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control form-account" placeholder="{{ trans('lang.Telephone') }}">
                        </div>
                        <div class="form-group">
                            <textarea rows="7" name="note" placeholder="{{ trans('lang.Tell Us More') }}" class="form-control form-account"></textarea>
                        </div>
                        <div class="btn-button-group mg-top-30 mg-bottom-15">
                            <button type="submit" class="zoa-btn btn-login hover-white">{{ trans('lang.Send Message') }}</button>
                        </div>
                    </form>
                </div>
            </div>
