<footer class="footer v2">
    <div class="container">
        <div class="row">
            <div class="footerDesc">
                <div class="col-lg-4">
                    ...
                    <p style="color:black; font-size:13px;">{{ trans('lang.Address Office') }} </p>
                ...
                <div class="col-lg-5">
                    <h3>{{ trans('lang.Related pages') }}</h3>
                    <div class="row">
                ...
                <div class="col-lg-3">
                    ...
                    <div class="row">
                        <div class="infomation pt-4">
                            <p><i style="font-size:22px" class="fa fa-phone" aria-hidden="true"></i>{{ trans('lang.Telephone') }}:<a href="tel:055-227-73-89">+994 55 227 73 89</a> </p>
                            <p><i style="font-size:22px" class="fa fa-envelope-o" aria-hidden="true"></i>{{ trans('lang.Email') }}: info@reyoungel.az</p>
        ...
        <div class="f-content bd-top">
            <p>{{ trans('lang.Copyright') }} © 2021 <a style="font-family: Eina, sans-serif " href="https://reyoungel.az/">Reyoungel</a>.{{ trans('lang.Made in England') }} .</p>
            ...
            <div class="f-col align-items-center">
                <p>{{ trans('lang.Powered by') }} <a style="font-family: Eina, sans-serif " href="https://hublink.az/">Hublink</a></p>
                <ul>
