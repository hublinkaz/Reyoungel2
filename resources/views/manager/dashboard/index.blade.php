                    ...
                    <table class="table table-bordernone">
                        ...
                        @foreach ($manager_prices as $manager_price)
                            ...
                            <tr>
                                ...
                                <td><a href="{{route('manager.manager.profile',$manager_price->id)}}">{{$manager_price->id}} </a></td>
                                <td><a href="{{route('manager.manager.profile',$manager_price->id)}}">{{ $manager_price->first_name}} {{$manager_price->last_name}}</a></td>
