                        ...
                        <div class="dt-ext table-responsive">
                            <table class="display" id="export-button">
                                ...
                                @foreach ($products as $product)
                                    <tr>
                                        <td><a href="{{route('manager.manager.deposit.detail',$product->id)}}">{{$product->id}}</a></td>

                                        <td><img style="width: 50px" src="/public/assets/images/product/{{ $product->image }}" alt="">
                                        </td>
                                        <td><a >{{ $product->{'name_'.app()->getLocale()}  }}</a></td>
                                        <td><a >{{ $product->price }} Azn</a></td>
                                        <td>{{ $product->qty }}</td>
                                        <td>{{ $product->qty * $product->price }} Azn</td>
                                    </tr>
                                @endforeach
                                <tr>
                                    <td></td>
                                    ...
                                    <td><a >{{ Round($total,1) }} Azn</a></td>
                                    <td>{{ $total_qty=null ? '0':$total_qty }} </td>
                                    <td></td>
                                </tr>
                                </tbody>
                                <tfoot>
