...
<table class="table">
    ...
    <tr>
        ...
        <th scope="col" class="border-0 pl-0">{{ trans('lang.Doctor') }}</th>
    ...
    @foreach($items as $item)
        ...
        <tr>
            <td class="pl-0">{{ $i }}</td>
            <td class="pl-0">{{ $item->{'product_name_'.app()->getLocale()}  }}</td>
            <td class="pl-0">{{ $item->first_name }} {{ $item->last_name }}</td>
...
{{--                <td class="text-center">{{ $item['name'] }}</td>--}}
            ...
            <td class="text-right">{{ round($item->paid,1) }}</td>

            <td class="text-right pr-0">
                {{ round(($item->paid*0.1),1) }} Azn
            </td>
        </tr>
        {{$i++}}
        {{ ($count=$count+($item->paid*0.1)) }}
    @endforeach
