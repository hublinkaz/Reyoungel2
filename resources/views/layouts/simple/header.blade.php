            ...
            <ul class="nav-menus">
              ...
              @if(Auth::user()->role_id===1 or Auth::user()->role_id===2 or Auth::user()->role_id===3)
                ...
                <li class="cart-nav onhover-dropdown">
                    <div class="cart-box"><a  href="{{route('checkout')}}"><i data-feather="shopping-cart"></i></a><span class="total-count badge rounded-pill badge-primary"></span></div>
                </li>
                    <li class="cart-nav onhover-dropdown">
                ...
                <li class="onhover-dropdown p-0 me-0">
                    ...
                    <ul class="profile-dropdown onhover-show-div">
                        ...
                        <li><a href="{{route('password-reset')}}"><i data-feather="shield"></i><span>Password</span></a></li>
{{--                        <li><a href="#"><i data-feather="file-text"></i><span>Taskboard</span></a></li>--}}
{{--                        <li><a href="#"><i data-feather="settings"></i><span>Settings</span></a></li>--}}
{{--                        <li><a href="#"><i data-feather="log-in"> </i><span>Log in</span></a></li>--}}
                        <li><a href="{{ route('logout') }}"><i data-feather="log-in"> </i><span>Sign-out</span></a></li>
