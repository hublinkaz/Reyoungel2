    ...
    <div class="container-fluid">
        <div class="edit-profile">
            <div class="row">
                ...
                <div class="col-xl-8">
                    <form class="card" action="{{ route('query.post') }}" method="POST" enctype="multipart/form-data">
                        @csrf
...
{{--                                        <img class="img-70 rounded-circle" alt="image" src="/assets/images/avtar/{{$account->image}}">--}}
                                        ...
                                        <div class="media-body">
                                            <h3 class="mb-1">{{$product[0]->first_name}} {{$product[0]->last_name}}</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select required id="status" name="status" class="form-control"  title="Select Status...">
                                            ...
                                            @elseif ($product[0]->status==2)
                                                <option  value="0">{{ trans('lang.Deactivate') }} </option>
                                                <option  value="1">{{ trans('lang.Active') }} </option>
                                                <option selected value="2">{{ trans('lang.Cancel') }} </option>
                                                @endif
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" placeholder="First Name" name="product_id" disabled id="product_id" value="{{$product[0]->{'name_'.app()->getLocale()} }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="number" placeholder="First Name" name="qty"  id="qty" value="{{$product[0]->qty}}">
                                    </div>
                                </div>
                                    <input class="" type="hidden" name="id" value="{{$product[0]->id}}">
                                    <input class="" type="hidden" name="product_id" value="{{$product[0]->product_id}}">
                            </div>
                        </div>
