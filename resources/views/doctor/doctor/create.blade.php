                        ...
                        <div class="card-body">
                            ...
                            <form class="theme-form" action="{{ route('user.registration') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" required="" name="workplace" placeholder="workplace" id="İş Yeri">
                                </div>

                                <div class="form-group">
                                    <label class="col-form-label">{{ trans('lang.Address') }}</label>
                                    <input class="form-control" type="text" required="" name="location" placeholder="Ünvan" id="Ünvan">
                                </div>
                                <div class="form-group">
