                            ...
                            <form class="theme-form" action="" method="POST" enctype="multipart/form-data">
                                ...
                                @method('PUT')
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control"  type="text" value="{{ $product->name }}" name="name" placeholder="Enter Name"><small class="form-text text-muted" >{{ trans('lang.We well never share your email with anyone else.') }}</small>
                                    </div>
                                    <div class="mb-3">
