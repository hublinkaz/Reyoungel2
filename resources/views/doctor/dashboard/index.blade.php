                        ...
                        <div class="bg-secondary b-r-4 card-body">
                            <div class="media static-top-widget">
                                ...
                                <div class="media-body">
                                    <span class="m-0">{{ trans('lang.Products') }}</span>

                                    <h4 class="mb-0 counter">{{\App\Models\Product::all()->count()}}</h4>
                    ...
                    <div class="card o-hidden">
                        <div class="bg-primary b-r-4 card-body">
                            <div class="media static-top-widget">
                                ...
                                <div class="media-body">
                                    <span class="m-0">{{ trans('lang.Doctors') }}</span>
                                    <h4 class="mb-0 counter">{{\App\Models\Doctors::all()->count()}}</h4>
                    ...
                    <div class="card o-hidden">
                        <div class="bg-primary b-r-4 card-body">
                            <div class="media static-top-widget">
                                ...
                                <div class="media-body">
                                    <span class="m-0">{{ trans('lang.Order') }}</span>
                                    <h4 class="mb-0 counter">{{\App\Models\Orders::all()->count()}}</h4>
