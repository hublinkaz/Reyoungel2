    ...
    <div class="header-wrapper row m-0">
        ...
        <div class="nav-right col-8 pull-right right-header p-0">
            <ul class="nav-menus">
                ...
                <li class="onhover-dropdown">
                    <div class="notification-box"><a href="/staff-panel/orders"> <i data-feather="bell">
                ...
                <li class="onhover-dropdown p-0 me-0">
                    ...
                    <ul class="profile-dropdown onhover-show-div">
                        <li><a href="{{route('staff.account')}}"><i data-feather="user"></i><span>{{ trans('lang.Account') }}</span></a></li>
                        <li><a href="{{route('staff.password-reset')}}"><i data-feather="shield"></i><span>{{ trans('lang.Password') }} </span></a></li>
