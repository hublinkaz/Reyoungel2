...
{{--                                        </div>--}}
                            ...
                            <hr>
                            <div class="">
                                <a class="btn btn-primary" href="/staff-panel/manager/deposit/{{$manager->user_id}}">Deposit</a>
                                <a class="btn btn-success" href="/staff-panel/manager/warehouse/{{$manager->user_id}}">Warehouse</a>
                            </div>
