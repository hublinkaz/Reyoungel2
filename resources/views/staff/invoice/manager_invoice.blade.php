...
<table class="table">
    <thead>
    <tr>
        <th scope="col" class="border-0 pl-0">Təhvil verdi : {{ $staff['name'] }}</th>
        <th scope="col" class="border-0 pl-0">Təsdiq Etdi: Direktor Hüseyn Xəlilov</th>
        <th scope="col" class="border-0 pl-0">Təhvil aldı : {{ $manager['name'] }}</th>

    </tr>
    </thead>
    <tbody>
    <tr>
        <td class="pl-0">(İmza)_____________________</td>
        <td class="pl-0">(İmza)_____________________</td>
        <td class="pl-0">(İmza)_____________________</td>
    </tr>
    <tr>
