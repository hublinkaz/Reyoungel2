                    ...
                    <div class="card hovercard text-center">
                        ...
                        <div class="info">
                            ...
                            <div class="">
                                ...
                                <a class="btn btn-primary" href="/staff-panel/doctor/deposit/{{$doctor->user_id}}">{{ trans('lang.Deposit') }}</a>
                                <a class="btn btn-primary" href="/staff-panel//doctor/orders/{{$doctor->user_id}}">{{ trans('lang.Orders') }}</a>
                                <a class="btn btn-danger" href="/staff-panel//doctor/edit/password/{{$doctor->user_id}}">{{ trans('lang.Password Reset') }}</a>
                            ...
                            <div class="dt-ext table-responsive">
                                <table class="display" id="export-button">
                                    ...
                                    @foreach ($payments as $payment)
                                        <tr>
                                            <td><a href="/panel/orders/detail/{{$payment->orderid}}">{{$payment->od_id}}</a></td>
                                            ...
                                            <td><a href="/panel/manager/{{$payment->manager_id}}">{{ $payment->manager_first_name }} {{ $payment->manager_last_name }}</a></td>
