                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="theme-form" action="{{ route('staff.create.doctor.update') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" required="" name="location" placeholder="{{ trans('lang.Address') }}" id="Ünvan">
                                </div>
                                <div class="form-group">
