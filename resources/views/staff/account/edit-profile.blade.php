    ...
    <div class="container-fluid">
        <div class="edit-profile">
            <div class="row">
                ...
                <div class="col-xl-8">
                    <form class="card" action="{{ route('staff.account.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" required="" name="card_number" value="{{$account->card_number}}" placeholder="{{ trans('lang.Card identity') }}" id="card_number">
                                    </div>
                                </div>
