                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="theme-form" action="{{ route('staff.blog.update',$product->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                    <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control btn-square" id="detail_az"  name="detail_az">{{ $product->desc_az }}</textarea>
                                    </div>
                                <div class="mb-3">
                                    <label class="col-form-label pt-0" for="exampleInputPassword1">{{ trans('lang.Desc') }} EN</label>
                                    <textarea class="form-control btn-square" id="detail_en"  name="detail_en">{{ $product->desc_en }}</textarea>
                                </div>
                                <div class="mb-3">
                                    <label class="col-form-label pt-0" for="exampleInputPassword1">{{ trans('lang.Desc') }} RU</label>
                                    <textarea class="form-control btn-square" id="detail_ru"  name="detail_ru">{{ $product->desc_ru }}</textarea>
                                </div>
                                <div class="mb-3">
                                    <label class="col-form-label pt-0" for="exampleInputPassword1">{{ trans('lang.Desc') }} TR</label>
                                    <textarea class="form-control btn-square" id="detail_tr"  name="detail_tr">{{ $product->desc_tr }}</textarea>
                                </div>
