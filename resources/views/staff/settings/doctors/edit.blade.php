            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="container mt-5">
                        ...
                        <form  action="{{ route('staff.front.doctors.update') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control"  type="text" name="name" value="{{$doctor->name}}" placeholder="{{ trans('lang.Enter Name') }}">
                            </div>
                            <div class="mb-3">
                                <label class="col-form-label pt-0" for="exampleInputEmail1">{{ trans('lang.Phone') }}</label>
                                <input class="form-control" type="text" name="phone" value="{{$doctor->phone}}" placeholder="{{ trans('lang.Phone') }}">
                            </div>


                            <div class="mb-3">
                                <label class="col-form-label pt-0" for="exampleInputEmail1">{{ trans('lang.WorkPlace') }}</label>
                                <input class="form-control" type="text" name="workplace" value="{{$doctor->workplace}}" placeholder="{{ trans('lang.WorkPlace') }}">
                            </div>
                            <div class="mb-3">
                                <label class="col-form-label pt-0" for="exampleInputEmail1">{{ trans('lang.location') }}</label>
                                <input class="form-control" type="text" name="location" value="{{$doctor->location}}" placeholder="{{ trans('lang.location') }}">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control btn-square" id="detail" name="text">{{$doctor->text}}</textarea>
                            </div>
