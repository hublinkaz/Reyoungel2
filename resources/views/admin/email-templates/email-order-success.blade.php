          ...
          <td>
            <table align="center" border="0" cellpadding="0" cellspacing="0">
              <tbody>
                ...
                <tr>
                  <td>
                    <h2 class="title">{{ trans('lang.thank you') }}</h2>
                  </td>
                </tr>
                <tr>
                  <td>
                    <p>{{ trans('lang.Payment Is Successfully Processsed And Your Order Is On The Way') }}</p>
                    <p>{{ trans('lang.Transaction ID:267676GHERT105467') }}</p>
                  </td>
                </tr>
                <tr>
                  <td>
            ...
            <table border="0" cellpadding="0" cellspacing="0">
              <tbody>
                <tr>
                  <td>
                    <h2 class="title">{{ trans('lang.YOUR ORDER DETAILS') }}</h2>
                  </td>
                </tr>
              </tbody>
            </table>
            <table class="order-detail" border="0" cellpadding="0" cellspacing="0" align="left">
              <tbody>
                <tr align="left">
                  ...
                  <th style="padding-left: 15px;">{{ trans('lang.DESCRIPTION') }}</th>
                ...
                <tr>
                  ...
                  <td valign="top" style="padding-left: 15px;">
                    <h5 style="margin-top: 15px;">{{ trans('lang.Three seater Wood Style sofa for Leavingroom') }} </h5>
                  </td>
                  <td valign="top" style="padding-left: 15px;">
                ...
                <tr>
                  <td colspan="2" style="line-height: 49px;font-size: 13px;color: #000000;padding-left: 20px;text-align:left;border-right: unset;">{{ trans('lang.Products:') }}</td>
                ...
                <tr>
                  <td colspan="2" style="line-height: 49px;font-size: 13px;color: #000000;padding-left: 20px;text-align:left;border-right: unset;">{{ trans('lang.Discount :') }}</td>
                ...
                <tr>
                  <td colspan="2" style="line-height: 49px;font-family: Arial;font-size: 13px;color: #000000;padding-left: 20px;text-align:left;border-right: unset;">{{ trans('lang.Gift Wripping:') }} </td>
                ...
                <tr>
                  <td colspan="2" style="line-height: 49px;font-size: 13px;color: #000000;                  padding-left: 20px;text-align:left;border-right: unset;">{{ trans('lang.Shipping:') }} </td>
                ...
                <tr>
                  <td colspan="2" style="line-height: 49px;font-size: 13px;color: #000000;                  padding-left: 20px;text-align:left;border-right: unset;">{{ trans('lang.TOTAL PAID :') }}</td>
                  <td class="price" colspan="3" style="line-height: 49px;text-align: right;padding-right: 28px;font-size: 13px;color: #000000;text-align:right;border-left: unset;"><b>$2600</b></td>
                </tr>
              </tbody>
            </table>
              ...
              <tbody>
                <tr>
                  <td style="font-size: 13px; font-weight: 400; color: #444444; letter-spacing: 0.2px;width: 50%;">
                    <h5 style="font-size: 16px; font-weight: 500;color: #000; line-height: 16px; padding-bottom: 13px; border-bottom: 1px solid #e6e8eb; letter-spacing: -0.65px; margin-top:0; margin-bottom: 13px;">{{ trans('lang.DILIVERY ADDRESS') }}</h5>
                    <p style="text-align: left;font-weight: normal; font-size: 14px; color: #000000;line-height: 21px;    margin-top: 0;">Ehmed Recebli Esra Plaza,<br> Hublink <br>Digital Studio</p>
                  </td>
                  ...
                  <td class="user-info" style="font-size: 13px; font-weight: 400; color: #444444; letter-spacing: 0.2px;width: 50%;">
                    <h5 style="font-size: 16px;font-weight: 500;color: #000; line-height: 16px; padding-bottom: 13px;
                    border-bottom: 1px solid #e6e8eb; letter-spacing: -0.65px; margin-top:0; margin-bottom: 13px;">SHIPPING ADDRESS</h5>
                    <p style="text-align: left;font-weight: normal; font-size: 14px; color: #000000;line-height: 21px;
                    margin-top: 0;">Ehmed Recebli Esra Plaza,<br> Hublink <br>Digital Studio</p>
                  </td>
                </tr>
              </tbody>
            </table>
      ...
      <tbody>
        <tr>
          <td style="padding: 30px;">
            <div>
              <h4 class="title" style="margin:0;text-align: center;">{{ trans('lang.Follow us') }}</h4>
            </div>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin: 20px auto 0;">
              <tbody>
                <tr>
                  <td><a href="#" style="font-size:13px">{{ trans('lang.Want to change how you receive these emails?') }}</a></td>
                </tr>
                <tr>
                  <td>
