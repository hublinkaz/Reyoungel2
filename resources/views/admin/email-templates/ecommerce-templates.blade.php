        ...
        <tr>
          <td>
            <table align="left" border="0" cellpadding="0" cellspacing="0" style="text-align: left;" width="100%">
              <tbody>
                <tr>
                  <td style="text-align: center;"><img src="{{asset('assets/images/email-template/delivery-2.png')}}" alt="" style=";margin-bottom: 30px;"></td>
                </tr>
                <tr>
                  <td>
                    <p style="font-size: 14px;"><b>{{ trans('lang.Hi,') }}</b></p>
                    <p style="font-size: 14px;">{{ trans('lang.Order Is Successfully Processsed And Your Order Is On The Way,') }}</p>
                    <p style="font-size: 14px;">{{ trans('lang.Transaction ID : 267676GHERT105467,') }}</p>
                  </td>
                </tr>
              </tbody>
            </table>
              ...
              <tbody>
                <tr>
                  <td style="background-color: #fafafa;border: 1px solid #ddd;padding: 15px;letter-spacing: 0.3px;width: 50%;">
                    <h5 style="font-size: 16px; font-weight: 600;color: #000; line-height: 16px; padding-bottom: 13px; border-bottom: 1px solid #e6e8eb; letter-spacing: -0.65px; margin-top:0; margin-bottom: 13px;">{{ trans('lang.Your Shipping Address') }}</h5>
                    <p style="text-align: left;font-weight: normal; font-size: 14px; color: #000000;line-height: 21px;    margin-top: 0;">{{ trans('lang.268 Cambridge Lane New Albany,<br> IN 47150268 Cambridge Lane <br>New Albany, IN 47150') }}</p>
                  </td>
