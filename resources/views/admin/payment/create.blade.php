                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="theme-form" action="{{ route('payment.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <p>{{ trans('lang.Enter your Doctor Payment') }}</p>
                                ...
                                <div class="form-group">
                                    <label class="col-form-label">{{ trans('lang.Paid') }}</label>
                                    <input class="form-control" type="text" id="paid" name="paid" required="" placeholder="{{ trans('lang.Paid') }}">
