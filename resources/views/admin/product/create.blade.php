                        ...
                        <div class="card-body">
                            ...
                            <form class="theme-form" action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" name="qty" placeholder="Enter Qty"><small class="form-text text-muted" id="emailHelp">{{ trans('lang.We well never share your email with anyone else.') }}</small>
                                </div>
                                <div class="mb-3">
                                    <label class="col-form-label pt-0" for="exampleInputEmail1">{{ trans('lang.Price') }}</label>
                                    <input class="form-control" type="text" name="price" placeholder="Enter Price"><small class="form-text text-muted" id="emailHelp">{{ trans('lang.We well never share your email with anyone else.') }}</small>
                                </div>
                                <div class="mb-3">
                                    <label class="col-form-label pt-0" for="exampleInputEmail1">{{ trans('lang.Cost') }}</label>
                                    <input class="form-control" type="number" name="cost" placeholder="Enter Cost"><small class="form-text text-muted" id="emailHelp">{{ trans('lang.We well never share your email with anyone else.') }}</small>
                                </div>

                                <div class="mb-3">
                                    <label class="col-form-label pt-0" for="exampleInputEmail1">{{ trans('lang.Units') }}</label>
                                    <input class="form-control" type="text" name="units" placeholder="Enter Units"><small class="form-text text-muted" id="emailHelp">{{ trans('lang.We well never share your email with anyone else.') }}</small>
                                </div>
                                <div class="mb-3">
