                                ...
                                <div class="product-box">
                                    <div class="product-img">
                                        ...
                                        <div class="product-hover">
                                            <ul>
                                                <li>
                                                    <button class="btn add-to-cart" type="button" data-id="{{$product->id}}" data-price="{{$product->price}}" data-name_az="{{$product->name_az }}" data-name_en="{{$product->name_en }}" data-name_ru="{{$product->name_ru }}" data-name_tr="{{$product->name_tr }}" data-image="{{$product->image}}"><i class="icon-shopping-cart"></i></button>
                                                </li>
                                                <li>
