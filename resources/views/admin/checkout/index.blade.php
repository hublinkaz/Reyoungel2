                        ...
                        <div class="dt-ext table-responsive">
                            <table class="display" id="export-button">
                                ...
                                @foreach ($products as $product)
                                    <tr>
                                        <td><img style="width: 50px" src="/public/assets/images/product/{{ $product->image }}" alt="{{ $product->name_en }}">
                                        </td>
                                        @if(app()->getLocale()=='az')
                                        ...
                                        <td><form action="{{ route('products.destroy',$product->id) }}" method="POST">
                                                ...
                                                <a class="btn btn-primary" href="{{ route('products.edit',$product->id) }}">{{ trans('lang.Edit') }}</a>
