...
@section('content')
    <div class="container-fluid">
            <a class="btn btn-outline-secondary-2x" href="/admin-panel/order/driver/{{$id}}">{{ trans('lang.Assign a driver') }}</a>
...
{{--                                                <form action="{{ route('return.post',$product->order_details_id) }}" method="POST">--}}
{{--                                                    @csrf--}}

{{--                                                    <input  type="number"  name="order_details_id" id="order_details_id" value="{{$product->order_details_id}}" >--}}
{{--                                                    <button type="submit" class="form-control btn btn-success btn-xs"  data-original-title="btn btn-success btn-xs">Dəyişdir</button>--}}
...
{{--                                            </td>--}}
                                            <td>
                                                <form action="{{ route('return.post',$product->order_details_id) }}" method="POST">
                                                    ...
                                                    <input  type="hidden"  name="order_details_id" id="order_details_id" value="{{$product->price - $product->paid }}" >

                                                   @if(is_null($product->order_details_paid))
...
{{--                                                    <input  type="number"  name="order_details_id" id="order_details_id" value="{{$product->price - $product->paid }}" >--}}
{{--                                                    <button type="submit" class="form-control btn btn-success btn-xs"  data-original-title="btn btn-success btn-xs">Dəyişdir</button>--}}
...
{{--                                            </td>--}}
                                            ...
                                            <td>
                                                <form action="{{ route('return.post',$product->order_details_id) }}" method="POST">
                                                    ...
                                                    @if(!empty($product->order_details_paid))
                                                        <button type="submit" class="form-control btn btn-success btn-xs"  disabled data-original-title="btn btn-success btn-xs">{{ trans('lang.Change') }}</button>
