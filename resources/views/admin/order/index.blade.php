                   ...
                   <th>{{ trans('lang.Action') }}</th>
                                ...
                                @foreach ($products as $product)
                                    <tr>
                                        ...
                                        <td><a href="/admin-panel/doctor/{{$product->doctor_id}}">{{ $product->doctor_first_name }} {{ $product->doctor_last_name }}</a></td>
                                        <td><a href="/admin-panel/manager/{{$product->manager_id}}">{{ $product->manager_first_name }} {{ $product->manager_last_name }}</a></td>
                                        ...
                                        <td><a class="btn btn-success " href="{{route('order.invoice',$product->order_id)}}">{{ trans('lang.Report') }}</a></td>
