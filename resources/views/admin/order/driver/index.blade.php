						...
						<table class="display" id="export-button">
                            ...
                            @foreach ($drivers as $driver)
								<tr>
									...
									<td><form action="{{ route('product.delete',$driver->id) }}" method="POST">


                                            <a class="btn btn-primary" href="{{ route('product.edit',$driver->id) }}">{{ trans('lang.Edit') }}</a>
