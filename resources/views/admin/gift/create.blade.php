                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="theme-form" action="{{ route('gift.post') }}" method="POST" enctype="multipart/form-data">
                                @csrf
...
{{--                                <p>Enter your Doctor Payment</p>--}}
                                ...
                                <div class="form-group">
                                    ...
                                    <select required id="order_id" name="order_id" class="form-control"  title="Select Order...">
                                        <option>{{ trans('lang.Select the order id') }}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select required id="product_id" name="product_id" class="form-control"  title="{{ trans('lang.Select Product...') }}">
