                            ...
                            <table class="display" id="basic-1">
                                ...
                                @foreach ($gifts as $gift)
                                    <tr>
                                        ...
                                        <td><a >{{ $gift->created_at }}</a></td>
                                        <td>
                                            <form action="{{ route('gift.query.post',$gift->gift_id) }}" method="POST">
                                                @csrf

                                                <select  style="color:#FF6800" required id="status" name="status" class="form-control"  title="Select Manager...">

                                                            <option selected value="1">{{ trans('lang.With approval ') }}</option>
                                                            <option value="0">{{ trans('lang.Cancel') }}</option>
                                                ...
                                                <input  type="hidden"  name="gift_id" id="gift_id" value="{{$gift->gift_id}}" >
