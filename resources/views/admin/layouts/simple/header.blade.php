...
<div class="page-header">
    <div class="header-wrapper row m-0">
        ...
        <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="{{route('admin.dashboard')}}"><img class="img-fluid"  src="{{asset('assets/images/logo/logo.png')}}" alt=""></a></div>
        ...
        <div class="nav-right col-8 pull-right right-header p-0">
            <ul class="nav-menus">
                ...
                <li class="onhover-dropdown">
                    <div class="notification-box"><a href="/admin-panel/orders"> <i data-feather="bell">
...
{{--                    <div class="cart-box"> <a class="btn btn-success "   style="font-size: 12px;"  href="{{route('checkout')}}">{{ trans('lang.Sale and Deposite') }}</a><span class="total-count badge rounded-pill badge-primary"></span></div>--}}
{{--                </li>--}}
...
{{--                        <div class="cart-box"> <a class="btn btn-primary " style="font-size: 12px"   href="{{route('manager.checkout')}}">{{ trans('lang.Require the product') }}</a><span class="total-count badge rounded-pill badge-primary"></span></div>--}}
...
{{--                        <li><a href="#"><i data-feather="log-in"> </i><span>Log in</span></a></li>--}}
        ...
        <script class="empty-template" type="text/x-handlebars-template"><div class="EmptyMessage"> {{ trans('lang.Your search turned up 0 results. This most likely means the backend is down, yikes!') }} </div></script>
    </div>
</div>
