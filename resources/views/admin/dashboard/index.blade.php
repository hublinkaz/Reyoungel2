    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header">
                <h5>{{ trans('lang.Daily Operations') }}</h5>
                ...
                <div class="user-status table-responsive">
                    <table class="table table-bordernone">
                        ...
                        <tr>
                            ...
                            <th scope="col">{{ trans('lang.Manager Name') }}</th>
                            <th scope="col">{{ trans('lang.Price Qty') }}</th>
                            <th scope="col">{{ trans('lang.Total Payment') }}</th>
                            <th scope="col">{{ trans('lang.Operation Qty') }}</th>
                            <th scope="col">{{ trans('lang.Totol Operation Paid') }}</th>
                        ...
                        @foreach ($managers as $manager)
                            ...
                            <tr>
                                ...
                                <td><a href="{{route('manager.profile',$manager->id)}}">{{$manager->id}} </a></td>
                                <td><a href="{{route('manager.profile',$manager->id)}}">{{ $manager->first_name}} {{$manager->last_name}}</a></td>
                                <td>{{$manager->qty}}</td>
...
<br>
                    <table class="table table-bordernone">
                        ...
                        <tr>
                            ...
                            <th scope="col">{{ trans('lang.Manager Name') }}</th>
                               <th scope="col">{{ trans('lang.Totol Operation Paid') }}</th>
                            <th scope="col">{{ trans('lang.Paid Company') }}</th>
                            <th scope="col">{{ trans('lang.Manager Paid') }}</th>
                        ...
                        @foreach ($manager_prices as $manager_price)
                            ...
                            <tr>
                                ...
                                <td><a href="{{route('manager.profile',$manager_price->id)}}">{{$manager_price->id}} </a></td>
                                <td><a href="{{route('manager.profile',$manager_price->id)}}">{{ $manager_price->first_name}} {{$manager_price->last_name}}</a></td>
                                <td>{{$manager_price->paid}}</td>
                                <td>{{$manager_price->paid-round($manager_price->manager,1)}}</td>
                                <td>{{round($manager_price->manager,1)}}</td>
                ...
                <div class="card">
                    <div class="mobile-clock-widget">
                        ...
                        <div>
                            ...
                            <div>
                                <p class="m-0 f-14 text-light">{{ trans('lang.Daily reports must be submitted by 04:00.') }}</p>
...
{{--                                    <span class="mb-1">Product for sale</span>--}}
{{--                                    <h4 class="mb-0 counter">{{\App\Models\OrderDetails::all()->count()}}</h4>--}}
{{--                                </div>--}}
