                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="theme-form" action="{{ route('create.manager.update') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="card_number" placeholder="{{ trans('lang.Passport') }} " id="card_number">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="password" required="" name="password_confirmation" placeholder="{{ trans('lang.Confirm Password') }}" id="password_confirmation">
                                </div>
