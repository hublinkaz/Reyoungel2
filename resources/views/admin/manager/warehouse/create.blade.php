...
@section('breadcrumb-items')
    ...
    <li class="breadcrumb-item active">{{ trans('lang.Product') }}</li>
@endsection
            ...
            <div class="feature-products">
               ...
               Filters<span class="ms-2"><i class="toggle-data" data-feather="chevron-down"></i></span></span>
                    ...
                    <div class="col-md-6 text-end">
                        ...
                        <span class="f-w-600 m-r-5">{{ trans('lang.Showing Products 1 - 24 Of 200 Results') }}</span>
                        <div class="select2-drpdwn-product select-options d-inline-block">
                            <select class="form-control btn-square" name="select">
                                <option value="opt1">{{ trans('lang.Featured') }}</option>
                                <option value="opt2">{{ trans('lang.Lowest Prices') }}</option>
                                <option value="opt3">{{ trans('lang.Highest Prices') }}</option>
                            </select>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="filter-section">
                                <div class="card">
                                    <div class="card-header">
                                        <h6 class="mb-0 f-w-600">{{ trans('lang.Filters') }}<span class="pull-right"><i class="fa fa-chevron-down toggle-data"></i></span></h6>
                                    </div>
                                    <div class="left-filter">
                                        <div class="card-body filter-cards-view animate-chk">
                                            <div class="product-filter">
                                                <h6 class="f-w-600">{{ trans('lang.Category') }}</h6>
                                                <div class="checkbox-animated mt-0">
                                                    <label class="d-block" for="edo-ani5">
                                                        <input class="radio_animated" id="edo-ani5" type="radio" data-original-title="" title="">{{ trans('lang.Man Shirt') }}
                                                    </label>
                                                    <label class="d-block" for="edo-ani6">
                                                        <input class="radio_animated" id="edo-ani6" type="radio" data-original-title="" title="">{{ trans('lang.Man Jeans') }}
                                                    </label>
                                                    <label class="d-block" for="edo-ani7">
                                                        <input class="radio_animated" id="edo-ani7" type="radio" data-original-title="" title="">{{ trans('lang.Woman Top') }}
                                                    </label>
                                                    <label class="d-block" for="edo-ani8">
                                                        <input class="radio_animated" id="edo-ani8" type="radio" data-original-title="" title="">{{ trans('lang.Woman Jeans') }}
                                                    </label>
                                                    <label class="d-block" for="edo-ani9">
                                                        <input class="radio_animated" id="edo-ani9" type="radio" data-original-title="" title="">{{ trans('lang.Man T-shirt') }}
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="product-filter">
                                                <h6 class="f-w-600">{{ trans('lang.Brand') }}</h6>
                                                <div class="checkbox-animated mt-0">
                                                ...
                                                <div class="product-box row">
                                                    ...
                                                    <div class="product-details col-lg-6 text-start">
                                                        ...
                                                        <div class="product-view">
                                                            <h6 class="f-w-600">{{ trans('lang.Product Details') }}</h6>
                                                            <p class="mb-0">{{ $product->detail }}</p>
                                                        </div>

                                                        <div class="product-qnty">
                                                            <h6 class="f-w-600">{{ trans('lang.Quantity') }}</h6>
                                                            <fieldset>
                                                            ...
                                                            <div class="addcart-btn">
                                                                <button class="btn btn-primary" type="button">{{ trans('lang.Add to Cart') }}</button>
                                                                <button class="btn btn-primary" type="button">{{ trans('lang.View Details') }}</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
