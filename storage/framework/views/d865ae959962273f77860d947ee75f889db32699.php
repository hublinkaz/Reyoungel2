...
<div class="page-header">
    <div class="header-wrapper row m-0">
        ...
        <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="<?php echo e(route('admin.dashboard')); ?>"><img class="img-fluid"  src="<?php echo e(asset('assets/images/logo/logo.png')); ?>" alt=""></a></div>
        ...
        <script class="empty-template" type="text/x-handlebars-template"><div class="EmptyMessage"> <?php echo e(trans('lang.Your search turned up 0 results. This most likely means the backend is down, yikes!')); ?> </div></script>
    </div>
</div>
<?php /**PATH /home/u553624116/domains/reyoungel.az/public_html/resources/views/admin/layouts/simple/header.blade.php ENDPATH**/ ?>