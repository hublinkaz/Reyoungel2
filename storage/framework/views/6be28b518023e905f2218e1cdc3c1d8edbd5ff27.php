                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="theme-form" action="<?php echo e(route('manager.create.doctor.update')); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" required="" name="location" placeholder="<?php echo e(trans('lang.Work location Name')); ?>" id="Ünvan">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label><?php echo e(trans('lang.Managers')); ?> *</label>
...
<?php echo $__env->make('manager.layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u553624116/domains/reyoungel.az/public_html/resources/views/manager/doctor/create.blade.php ENDPATH**/ ?>