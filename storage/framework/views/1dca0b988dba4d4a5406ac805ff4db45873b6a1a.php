                        ...
                        <div class="dt-ext table-responsive">
                            <table class="display" id="export-button">
                                ...
                                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($product->first_name); ?><?php echo e($product->last_name); ?>

                                        </td>
                                        <td><a ><?php echo e($product->{'name_'.app()->getLocale()}); ?></a></td>
                                        <td><?php echo e($product->qty); ?></td>
                                        <td><?php echo e($product->created_at); ?></td>
                                        <td><a class="btn btn-primary" href="<?php echo e(route('manager.query.edit',$product->id)); ?>"><?php echo e(trans('lang.Edit')); ?></a></td>
...
<?php echo $__env->make('admin.layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u553624116/domains/reyoungel.az/public_html/resources/views/admin/manager/queryproduct.blade.php ENDPATH**/ ?>