                    ...
                    <table class="table table-bordernone">
                        ...
                        <?php $__currentLoopData = $manager_prices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $manager_price): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo e(route('manager.manager.profile',$manager_price->id)); ?>"><?php echo e($manager_price->id); ?> </a></td>
                                <td><a href="<?php echo e(route('manager.manager.profile',$manager_price->id)); ?>"><?php echo e($manager_price->first_name); ?> <?php echo e($manager_price->last_name); ?></a></td>
...
<?php echo $__env->make('manager.layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u553624116/domains/reyoungel.az/public_html/resources/views/manager/dashboard/index.blade.php ENDPATH**/ ?>