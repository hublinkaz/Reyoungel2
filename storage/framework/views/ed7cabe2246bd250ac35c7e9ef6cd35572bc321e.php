                        ...
                        <div class="info">
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-lg-4 order-sm-2 order-xl-2">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="ttl-info text-start">
                                                <h6><i class="fa fa-location-arrow"></i><?php echo e(trans('lang.Address')); ?></h6>
                            ...
                            <div class="row">
                                <?php if(empty($doctor->description)): ?>
                                    <span><?php echo e(trans('lang.Ətraflı Məlumat Yoxdur')); ?></span>

                                <?php else: ?>
                                    <span><?php echo e($doctor->description); ?></span>
                            ...
                            <div class="">
                                ...
                                <a class="btn btn-primary" href="/admin-panel/doctor/deposit/<?php echo e($doctor->user_id); ?>"><?php echo e(trans('lang.Deposit')); ?></a>
                                <a class="btn btn-primary" href="/admin-panel/doctor/orders/<?php echo e($doctor->user_id); ?>"><?php echo e(trans('lang.Orders')); ?></a>
                                <a class="btn btn-danger" href="/admin-panel/doctor/edit/password/<?php echo e($doctor->user_id); ?>"><?php echo e(trans('lang.Password Reset')); ?></a>
                            ...
                            <div class="dt-ext table-responsive">
                                <table class="display" id="export-button">
                                    ...
                                    <?php $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><a href="/admin-panel/orders/detail/<?php echo e($payment->orderid); ?>"><?php echo e($payment->od_id); ?></a></td>
                                            ...
                                            <td><a href="/admin-panel/manager/<?php echo e($payment->manager_id); ?>"><?php echo e($payment->manager_first_name); ?> <?php echo e($payment->manager_last_name); ?></a></td>
...
<?php echo $__env->make('admin.layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u553624116/domains/reyoungel.az/public_html/resources/views/admin/doctor/profile.blade.php ENDPATH**/ ?>