                ...
                <div class="col-md-2 col-xs-6 col-sm-6 col2 flex align-items-center">
                    ...
                    <div class="col-md-8 col-xs-6 col-sm-6 col2 flex align-items-center">
                        <ul class="nav navbar-nav js-menubar hidden-xs hidden-sm">
                            <li class="level1 active dropdown"><a href="/" title="Home"><?php echo e(trans('lang.Home')); ?></a>
                            </li>
                            <li class="level1 dropdown hassub"><a href="/#products" title="Shop"><?php echo e(trans('lang.Products')); ?></a>
                            ...
                            <li class="level1 dropdown hassub"><a href="/contact" title="Shop"><?php echo e(trans('lang.Contact')); ?></a>
                            <li class="level1 dropdown hassub"><a href="/blogs" title="Shop"><?php echo e(trans('lang.Blog')); ?></a>
                            ...
                            <div class="dropdown mt-5">
                                ...
                                <div class="dropdown-menu">
                                    <?php $__currentLoopData = config('app.available_locales'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $locale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a href="<?php echo e(request()->url()); ?>?language=<?php echo e($locale); ?>"
                                           class="dropdown-item <?php echo e((App::getLocale()  == $locale) ? 'active' : ''); ?>">
                                            <div class="lang <?php echo e((App::getLocale()  == $locale) ? 'selected' : ''); ?>" data-value="en"><i class="flag-icon flag-icon-us"></i> <span class="lang-txt">
                                                    <?php if($locale=='az'): ?>
                                                        Azerbaijan
...
<?php /**PATH /home/u553624116/domains/reyoungel.az/public_html/resources/views/frontend/includes/header.blade.php ENDPATH**/ ?>