                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="theme-form" action="<?php echo e(route('report.product.post')); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u553624116/domains/reyoungel.az/public_html/resources/views/admin/report/product.blade.php ENDPATH**/ ?>