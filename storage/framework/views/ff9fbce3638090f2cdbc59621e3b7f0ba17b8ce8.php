...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <?php if(\Illuminate\Support\Facades\Auth::user()->role_id==1 or \Illuminate\Support\Facades\Auth::user()->role_id ==3): ?>
            <a class="btn btn-outline-secondary-2x" href="/panel/order/driver/<?php echo e($id); ?>"><?php echo e(trans('lang.Driver Assignment')); ?></a>
                        ...
                        <div class="table-responsive product-table">
                            <table class="display" id="basic-1">
                                ...
                                <tr>
                                    ...
                                    <th><?php echo e(trans('lang.Payment')); ?></th>
                                ...
                                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php else: ?>
                                        <tr>
                                            ...
                                            <td class="font-success"><?php echo e($product->order_detail_created); ?></td>
                                            <td class="font-success">
                                                <form action="<?php echo e(route('manager.payment.store',$product->order_details_id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>

                                                    <input  type="text"  name="paid" id="paid" min="1" max="<?php echo e($product->price-$product->paid); ?>" value="<?php echo e($product->price-$product->paid); ?>" >
                                                    <button type="submit" class="form-control btn btn-success btn-xs"  data-original-title="btn btn-success btn-xs"><?php echo e(trans('lang.Add Payment')); ?></button>

                                                </form>
                                            </td>

                                            <td>
                                                <form action="<?php echo e(route('manager.return.post',$product->order_details_id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
                                                    <?php if($product->is_return===0): ?>
                                                        <select style="color:#1100FF" required id="is_return" name="is_return" class="form-control"  title="Select Manager...">
...
<?php echo $__env->make('manager.layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u553624116/domains/reyoungel.az/public_html/resources/views/manager/order/detail.blade.php ENDPATH**/ ?>