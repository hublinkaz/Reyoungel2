...
<h3><?php echo e(trans('lang.Drivers')); ?></h3>
<?php $__env->stopSection(); ?>
						...
						<table class="display" id="export-button">
                            ...
                            <thead>
								<tr>
									...
									<th><?php echo e(trans('lang.Car Number')); ?></th>
                            ...
                            <?php $__currentLoopData = $drivers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $driver): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<tr>
									...
									<td><?php echo e($driver->car_number); ?></td>
									<td>


                                            <a class="btn btn-primary" href="<?php echo e(route('driver.edit',$driver->id)); ?>"><?php echo e(trans('lang.Edit')); ?></a>
...
<?php echo $__env->make('admin.layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u553624116/domains/reyoungel.az/public_html/resources/views/admin/driver/index.blade.php ENDPATH**/ ?>