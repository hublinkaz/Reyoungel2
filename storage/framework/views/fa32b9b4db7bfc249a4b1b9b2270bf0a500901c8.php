                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="theme-form" action="<?php echo e(route('products.store')); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" name="qty" placeholder="Enter Qty"><small class="form-text text-muted" id="emailHelp"><?php echo e(trans('lang.We well never share your email with anyone else.')); ?></small>
                                </div>
                                <div class="mb-3">
                                    <label class="col-form-label pt-0" for="exampleInputEmail1"><?php echo e(trans('lang.Price')); ?></label>
                                    <input class="form-control" type="text" name="price" placeholder="Enter Price"><small class="form-text text-muted" id="emailHelp"><?php echo e(trans('lang.We well never share your email with anyone else.')); ?></small>
                                </div>
                                <div class="mb-3">
                                    <label class="col-form-label pt-0" for="exampleInputEmail1"><?php echo e(trans('lang.Cost')); ?></label>
                                    <input class="form-control" type="number" name="cost" placeholder="Enter Cost"><small class="form-text text-muted" id="emailHelp"><?php echo e(trans('lang.We well never share your email with anyone else.')); ?></small>
                                </div>

                                <div class="mb-3">
                                    <label class="col-form-label pt-0" for="exampleInputEmail1"><?php echo e(trans('lang.Units')); ?></label>
                                    <input class="form-control" type="text" name="units" placeholder="Enter Units"><small class="form-text text-muted" id="emailHelp"><?php echo e(trans('lang.We well never share your email with anyone else.')); ?></small>
                                </div>
                                <div class="mb-3">
...
<?php echo $__env->make('admin.layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u553624116/domains/reyoungel.az/public_html/resources/views/admin/product/create.blade.php ENDPATH**/ ?>